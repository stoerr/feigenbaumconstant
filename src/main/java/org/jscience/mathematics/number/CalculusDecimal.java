...
final class CalculusDecimal {
    ...
    static final class MultiplyLogic implements Runnable {
        ...
        private DecimalInteger _left, _right, _value;
        
        public static MultiplyLogic newInstance(DecimalInteger left, DecimalInteger right) {
